...
class Property extends CI_Controller
{
	...
	public function post_property_data()
	{
		     ...
		     $request = json_decode($postdata);
			  ...
			  $property_name = $request->property_name;
			   ...
			   $city = $request->city;
			   $zip = $request->zip;
		     $success=$this->Property_model->post_property_data($property_name,$property_type_id,$building_name,$floor_no,$flat_no,$address,$country,$state,$city,$zip);	
	...
	public function update_property_data()
	{
		     ...
		     $success=$this->Property_model->update_property_data($property_name,$property_type_id,$building_name,$floor_no,$flat_no,$address,$country,$state,$city,$zip,$property_id);	
		     echo json_encode($success);
	}
  ...
  /*public function user_type_list()
	...
	public function edit_property_type_details($id)
	{
		...
		$data['user_info'] =$this->session->userdata('user_info');
		$data['data']=$this->Property_model->edit_property_type_details($id);
		//print_r($data);
		$this->load->view('common_header');
		$this->load->view('common_sidemenu',$data);
	...
	public function post_property_type()
	{
		     ...
		     $request = json_decode($postdata);
			  ...
			  $zip = $request->zip;
			 //$title ='test';
		     $success=$this->Property_model->post_property_type($title,$no_of_floor,$address,$country,$state,$city,$zip);	
		     echo json_encode($success);
	}
	public function update_property_type()
	{
		     ...
		     $request = json_decode($postdata);
			  ...
			  $no_of_floor = $request->no_of_floor_edit;
			 //$title ='test';
		     $success=$this->Property_model->update_property_type($title,$type_id,$no_of_floor);	
		     echo json_encode($success); */
		     ...
		     $request = json_decode($postdata);
			  ...
			  $zip = $request->zip;
			 //$title ='test';
		     $success=$this->Property_model->update_property_type($title,$property_id,$no_of_floor,$address,$country,$state,$city,$zip);	
		     echo json_encode($success);
	}
	...
	public function get_building_floor_details()
	{
		      $postdata = file_get_contents("php://input");
		     $request = json_decode($postdata);
		     $building_id = $request->building_id;
		     $success=$this->Property_model->get_building_floor_details($building_id);	
		     echo json_encode($success);
	}
	public function get_building_details()
	{
		      $postdata = file_get_contents("php://input");
		     $request = json_decode($postdata);
		     $building_id = $request->building_id;
		     $success=$this->Property_model->get_building_details($building_id);	
		     echo json_encode($success);
	}
