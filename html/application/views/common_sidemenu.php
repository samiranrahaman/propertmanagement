    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
			 ...
			 <li class="active treeview" >
				...
				<li <?php if(!(in_array('all',$resource_array) || in_array('DomesticsHelps',$resource_array))){ echo "style='display:none'";}?> class="active treeview">
				...
				<li <?php if(!(in_array('all',$resource_array) || in_array('Visitors',$resource_array))){ echo "style='display:none'";}?> class="active treeview">

					  <a href="#">
						<i class="fa fa-dashboard"></i> <span>Visitors Helps</span> <i class="fa fa-angle-left pull-right"></i>
					  </a>
				...
				<li <?php if(!(in_array('all',$resource_array) || in_array('GlobalNotification',$resource_array))){ echo "style='display:none'";}?> class="active treeview">
