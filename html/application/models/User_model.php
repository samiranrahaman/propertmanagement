...
class User_model extends CI_Model
{
	...
	public function post_add_user_tenant_api($firstname,$lastname,$phone1,$email,$user_type,$username,$password,$device_token,$building_id,$flat_no,$floor_no)
	{
		 ...
		 {
			  $sql12="SELECT * FROM  `ten_property_type` where id=".$building_id;
		      $query12= $this->db->query($sql12);
	          $query_res12=$query12->result();
			  $p_name=$query12->row()->title;
			  $data1 = array(
			  'name'=>$p_name,
		    ...
		    $this->db->insert('ten_propert_list',$data1);
		...
		//return $this->db->get_compiled_insert()	;
		 ...
		 $this->db->insert('ten_owner_propery',$data3);
		 return $id;
	...
	public function change_users_type($user_id,$user_type)
	{
		 $data = array(
		 'status' =>0,
		  'type_change_request' =>1,
		   'user_type' =>$user_type,
		);
		//print_r($data);
        $this->db->where('id',$user_id);
	...
	public function add_owner_property($user_id,$building_id,$flat_no,$floor_no)
	{
		...
		$this->db->insert('ten_owner_propery',$data);
        
		return 1;
		
		
	}
	public function edit_owner_property($user_id,$building_id,$flat_no,$floor_no,$property_id)
	{
		   ...
		   $this->db->update('ten_propert_list', $data1);
	...
	/* public function edit_tenant_property($user_id,$building_id,$flat_no,$floor_no,$property_id)
	{
	...
	public function edit_property($building_id,$flat_no,$floor_no,$property_id)
	{
