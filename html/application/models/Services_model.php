...
class Services_model extends CI_Model
{
	...
	{
		     $sql1="SELECT a.id,a.type,a.name 'service_name',a.created_at 'created_at',b.name 'service_type' from  ten_services_list a left join ten_services_type b on a.type=b.id order by a.id desc";
		 $query1= $this->db->query($sql1);
	     return $query_res1=$query1->result();
	} 
